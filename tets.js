        ...
        DBInfo = {
            ...
            openAttackDetail() {
                ...
                for (let index = 1; index < incTable.length - 1; index++) {
                    ...
                    // Automatischer Aufruf der showDatabaseDetails-Funktion
                    DBInfo.showDatabaseDetails(coords[0], coords[1], DBInfo.showAttackDetail, arrival);
            
                    // Entfernen des note.png-Bildes, da es nicht mehr benötigt wird
